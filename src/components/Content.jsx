  ...
  return (
    <>
      <div className="mb-auto">
        <section className="w-full bg-cover" style={{ height:"460px",backgroundImage:`url("https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/5f3d8d300f85afb219528a35_5f0d377cf77497567371549b_Banner%20(1).png")`}}>
          <div className="text-center pt-32">
            <h1 className="font-semibold text-6xl text-white">The Creative Industry's<br/>Premium Directory</h1>
            <p className="text-white mt-6" >Where innovative companies connect with vetted marketing,<br/> creative and media providers for all their marketing needs.</p>
            <div className="mt-12 text-white text-sm font-semibold font-barlow">
              <a href="/#" className="px-7 py-3 mx-1.5 bg-orange-f1">Post a Job for Free</a>
              <a href="/#" className="px-7 py-3 mx-1.5 bg-transparent border">Schedule a Call</a>
            </div>
          </div>
        </section>
        <section>
          <div className="flex flex-col lg:flex-row items-center my-4 mx-16">
            <div className="flex text-xs text-right text-white mb-2 lg:mb-0 lg:mr-10 w-36">Trusted by 1,500+ brands and agencies</div>
        ...
        <section className="bg-white block">
          <div className="flex flex-col items-center py-16">
            <div className="text-4xl text-gray-700 font-medium mb-16">Why GetCraft?</div>
            <div className="flex flex-col lg:flex-row items-center justify-between text-center mx-auto">
              <div className="flex flex-col content-center items-center text-center mr-5 mb-12 lg:mb-0">
                <img src="https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602f7ebd5473342759fab89b_Group%20533.png" loading="lazy" alt="" className="w-16 mb-6"/>
                <div className="w-64">
                  <div className="text-2xl font-semibold text-gray-600 mb-2">Vetted Creators</div>
              ...
              <div className="flex flex-col content-center items-center text-center mr-5 mb-12 lg:mb-0">
                <img src="https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602f7ebde07d0e32b80b8337_Group%20534.png" loading="lazy" alt="" className="w-16 mb-6"/>
                <div className="w-64">
                  <div className="text-2xl font-semibold text-gray-600 mb-2">Craft at Scale</div>
              ...
              <div className="flex flex-col content-center items-center text-center mr-5 mb-12 lg:mb-0">
                <img src="https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602f7ebdb4ac3caac8cd53c6_Group%20535.png" loading="lazy" alt="" className="w-16 mb-6"/>
                <div className="w-64">
                  <div className="text-2xl font-semibold text-gray-600 mb-2">Secure Payments</div>
              ...
              <div className="flex flex-col content-center items-center text-center mr-5 mb-12 lg:mb-0">
                <img src="https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602f7ebd5fedd1c706973aee_Group%20536.png" loading="lazy" alt="" className="w-16 mb-6"/>
                <div className="w-64">
                  <div className="text-2xl font-semibold text-gray-600 mb-2">Production Support</div>
        ...
        <section className="text-white py-5 ">
          <div className="text-center text-5xl text-white font-medium pt-20 mb-4">What's inside?</div>
          <div className="text-center text-xl lg:text-2xl text-white font-medium ">10,000+ Vetted Creative Professionals &amp; Businesses</div>
          <div className="flex flex-wrap my-12 mb-16 px-40 lg:px-72">
            <div className="w-full lg:w-1/2 px-2 mb-4 text-center lg:text-left flex flex-col">
              <h1 className="text-4xl mb-1.5 font-semibold">The Best Marketing  Specialists</h1>
              <div className="mb-4">Work with award-winning creative /<br/>strategic / media / research <br/>professionals and agencies</div>
            ...
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Digital Marketing <br/>Specialists &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Technology<br/>Specialists &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Research<br/>Specialists &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Branding <br/>Specialists &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Social Media <br/>Specialists &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
              <img src="https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602f46fbf4915e6d13c630ab_Group%20528.png" loading="lazy" alt="" className=""/>
                <div className="-mt-32 mb-16 text-center font-semibold font-rubik hover:underline">Media &amp;<br/>Performance <br/>Specialists &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-16 text-center font-semibold font-rubik hover:underline">Creative<br/>Ideation<br/> Specialists &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-16 text-center font-semibold font-rubik hover:underline">Content <br/>Strategy <br/>Speclialists &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">UX &amp; UI <br/>Specialists &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">PR &amp; Event <br/>Specialists &gt;</div>
              </a>
            </div>
          </div>
          
          <div className="flex flex-wrap mb-16 px-40 lg:px-72">
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Videographers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Writers &amp;<br/>Editors &gt;</div>
              </a>
            </div>
            <div className="w-full lg:w-1/2 px-2 mb-4 text-center lg:text-right flex flex-col">
              <h1 className="text-4xl mb-1.5 font-semibold">The Best Content Producers</h1>
              <div className="mb-4">Work with award-winning video /<br/>photography / writing / design<br/>professionals and studios</div>
              <div className="text-orange-f1"><a href="/#">Show more &gt;</a></div>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Photographers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Designers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Production<br/>Houses &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Design<br/>Studios &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                <img src="https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602f23cb75f67c9866f8349b_Group%20502.png" loading="lazy" alt="" className=""/>
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Producers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Translators &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
              <img src="https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602f23cbe683eb5fe9f0595b_Group%20504.png" loading="lazy" alt="" className=""/>
                <div className="-mt-32 mb-16 text-center font-semibold font-rubik hover:underline">Copywriters &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-16 text-center font-semibold font-rubik hover:underline">Illustrators &gt;</div>
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-wrap mb-16 px-40 lg:px-72">
            <div className="w-full lg:w-1/2 px-2 mb-4 text-center lg:text-left flex flex-col">
              <h1 className="text-4xl mb-1.5 font-semibold">The Best Media Partners</h1>
              <div className="mb-4">Work with celebrities &amp; influencers / <br/>online publishers / TV stations /<br/> radio stations / OOH vendors</div>
              <div className="text-orange-f1"><a href="/#">Show more &gt;</a></div>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Instagram <br/>Influencers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">YouTube<br/> Influencers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Bloggers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Podcasters &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Tiktok<br/> Influencers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
              <img src="https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602f23d15c60b2b27ff0d070_Group%20513.png" loading="lazy" alt="" className=""/>
                <div className="-mt-32 mb-16 text-center font-semibold font-rubik hover:underline">Twitter<br/> Influencers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-16 text-center font-semibold font-rubik hover:underline">TV <br/>Stations &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-16 text-center font-semibold font-rubik hover:underline">Radio <br/>Stations &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">OOH <br/>Providers &gt;</div>
              </a>
            </div>
            <div className="w-1/2 lg:w-1/4 px-2 mb-4">
              <a href="/#" className="hover:opacity-100 opacity-80 ">
                ...
                <div className="-mt-32 mb-20 text-center font-semibold font-rubik hover:underline">Online<br/>Publishers &gt;</div>
              </a>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white">
          <div className="flex flex-col items-center py-20 px-36">
            <div className="text-4xl text-gray-700 font-medium mb-12">How It Works</div>
            <div className="flex flex-col lg:flex-row items-center justify-between w-full text-center">
              <div className="flex flex-col content-center items-center text-center mr-5 mb-12 lg:mb-0">
                ...
                <div className=" mb-2">
                  <div className="text-2xl font-semibold text-gray-600 mb-2">Browse The Directory</div>
                ...
                <a href="/#" className="text-orange-f1 font-semibold">Browse Directory &gt;</a>
              </div>
              <div className="flex flex-col content-center items-center text-center mr-5 mb-12 lg:mb-0">
                ...
                <div className=" mb-2">
                  <div className="text-2xl font-semibold text-gray-600 mb-2">Post a Job</div>
                ...
                <a href="/#" className="text-orange-f1 font-semibold">Post a job &gt;</a>
              </div>
              <div className="flex flex-col content-center items-center text-center mr-5 mb-12 lg:mb-0">
                ...
                <div className=" mb-2">
                  <div className="text-2xl font-semibold text-gray-600 mb-2">Schedule a Call</div>
                ...
                <a href="/#" className="text-orange-f1 font-semibold">Schedule a call &gt;</a>
              </div>
            </div>
          </div>
        </section>
        <section>
          ...
          <div className="flex flex-col lg:flex-row mx-20 my-10 ">
        ...
        <section className="bg-white ">
          <div className="text-center py-14 text-4xl text-gray-600 font-semibold">Trusted by  1,500+ leading brands and agencies</div>
          <img src="https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602b854f35854db3293d42a5_Logo2.svg" loading="lazy" alt="" className="mx-auto"/>
        ...
        <section>
          <div className="w-full bg-cover" style={{ height:"460px",backgroundImage:`url("https://assets.website-files.com/5ee11789f9b8e4ffc2f230f5/602f4f626b6bfe3352b81f6c_Mask%20Group%20(1)%20(1).png")`}}>
            <h1 className="text-center text-white text-4xl font-semibold pt-32 mb-5">Apply as a Creator</h1>
            <div className="w-96 mx-auto">
              <p className="text-center text-white">GetCraft helps creators get discovered by more clients, sent more projects &amp; paid faster!</p>
              <div className="text-center mt-12">
                <a href="/#" className="px-7 py-4 text-white bg-orange-f1">Learn More</a>
              </div>
            </div>
